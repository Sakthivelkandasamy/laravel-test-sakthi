...
class ExampleTest extends TestCase
{
    ...
    public function testMenu() {
        ...
        $response->assertStatus(200)
            ...
            ->assertJsonPath('1.children.0.url', '/events/laracon/workshops/illuminate')
            ->assertJsonPath('1.children.1.url', '/events/laracon/workshops/eloquent')
            ->assertJsonPath('4.name', 'Reactcon')
            ->assertJsonPath('4.children.0.url', '/events/reactcon/workshops/noclass')
            ->assertJsonPath('4.children.1.url', '/events/reactcon/workshops/jungle');
    }
}
